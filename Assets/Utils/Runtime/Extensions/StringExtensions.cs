...
namespace App.Core.Extensions
{
    ...
    {
        public static string Rotate(this string s, int count)
        {
        ...
        public static void SystemCopy(this string st)
        {
            var textEditor = new TextEditor {text = st};
        ...
        /// <param name="login">Login or clientID</param>
        /// <param name="pass">pass or clientSecret</param>
        /// <returns></returns>
        public static string ConvertToBasicAuth(string login, string pass)
        {
            string auth = login + ":" + pass;
            return System.Convert.ToBase64String(System.Text.Encoding.GetEncoding("ISO-8859-1").GetBytes(auth));
        }
        ...
        {
            string pattern =
                "^[a-zA-Z0-9+=_]+[a-zA-Z0-9+=_.]+@[a-zA-Z0-9][\\w\\.-]*[a-zA-Z0-9]\\.[a-zA-Z][a-zA-Z\\.]*[a-zA-Z]$";
        ...
        /// </summary>
        public static string Substring(this string self, string end, bool includeEnd)
        {
            return Substring(self, 0, end, includeEnd);
        }
        ...
        public static string PerCentUpperEncode(this string s)
        {
        ...
        public static string GenerateRandomString(int length)
        {
            ...
            {
                builder.Append(pool[UnityEngine.Random.Range(0, pool.Length)]);
            }

            return builder.ToString();
        }

        public static bool IsHTMLModel(this string self)
        {
            ...
            return self.StartsWith("<!DOCTYPE") || self.StartsWith("<html");
        }

        public static bool IsValidUrlWithOptionalParams(this string urlToCheck)
        {
            if (string.IsNullOrEmpty(urlToCheck) || string.IsNullOrWhiteSpace(urlToCheck))
            {
                return false;
            }

            return Uri.IsWellFormedUriString(urlToCheck, UriKind.RelativeOrAbsolute);
        }

        public static string PerCentLowerEncode(this string s)
        {
            if (string.IsNullOrEmpty(s) || string.IsNullOrWhiteSpace(s))
            {
                return s;
            ...
            var upper = PerCentUpperEncode(s);
            return Regex.Replace(upper, @"%[a-f\d]{2}", m => m.Value.ToUpper());
        }
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static string RemoveXMLTags(string s, char tagStartChar = '<', char tagEndChar = '>')
        {
            if (!string.IsNullOrEmpty(s))
            {
