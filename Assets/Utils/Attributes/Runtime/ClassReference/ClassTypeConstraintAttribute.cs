...
public sealed class ClassExtendsAttribute : ClassTypeConstraintAttribute
{
    ...
    public override bool IsConstraintSatisfied(Type type)
    {
        ...
        return AssemblyType.IsGenericType
            ? IsAssignableFromGeneric(AssemblyType, type) // AssemblyType.IsAssignableFromGeneric(type)
            : AssemblyType.IsAssignableFrom(type);
    }

    private static bool IsAssignableFromGeneric(Type generic, Type toCheck)
    {
